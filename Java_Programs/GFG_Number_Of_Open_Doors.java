...
class GFG_Number_Of_Open_Doors {
...
// Explanation : Consider a long alley with a N number of doors on one side. All
// the doors are closed initially. You move to and fro in the alley changing the
// states of the doors as follows: you open a door that is already closed and
// you close a door that is already opened. You start at one end go on altering
// the state of the doors till you reach the other end and then you come back
// and start altering the states of the doors again.
...
// You continue this till the Nth go in which you alter the state of the door
// numbered N.
